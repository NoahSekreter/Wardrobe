...
namespace Wardrobe.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,TopID,BottomID,ShoesID,AccessoriesID")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,TopID,BottomID,ShoesID,AccessoriesID")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
