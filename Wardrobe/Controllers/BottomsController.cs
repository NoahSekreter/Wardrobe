...
namespace Wardrobe.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Name,Image,Type,Color,Season,Occasion,Waist,Length")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Name,Image,Type,Color,Season,Occasion,Waist,Length")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
